...
int GetSumPositiveElem(int[] arr)                 // первый вариант решения
{
    int sum = 0;
    for (int i = 0; i < arr.Length; i++)
    {
...
int GetSumNegativeElem(int[] arr)                 // первый вариант решения
{
    int sum = 0;
    for (int i = 0; i < arr.Length; i++)
    {
...
// int[] GetSumPositiveNegativeElem(int[] arr)    // второй вариант решения
// {
//     int sumNeg = 0;
//     int sumPos = 0;
//     for (int i = 0; i < arr.Length; i++)
